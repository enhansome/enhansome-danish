...
* [Byte-Pair Encoding embedding](https://github.com/bheinzerling/bpemb) ⭐ 1,222 | 🐛 6 | 🌐 Python | 📅 2024-10-01 - Gensim-based subword embedding. A large number of Danish embeddings are available. They differ in the size of the vocabulary (from 1000 to 200000) and subspace dimensions (from 25 to 300).
...
* [kaldi-sprakbanken](https://github.com/kaldi-asr/kaldi/tree/master/egs/sprakbanken/s5) ⭐ 15,458 | 🐛 261 | 🌐 Shell | 📅 2025-09-22 - A recipe for training state-of-the-art(2017) speech recogniser for Danish based on the 16kHz NST database.
...
* [dacy](https://github.com/KennethEnevoldsen/DaCy) ⭐ 104 | 🐛 4 | 🌐 Python | 📅 2026-06-11 - Danish spaCy pipeline.
