...
* [XED](https://github.com/Helsinki-NLP/XED) ⭐ 64 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2023-05-03 - emotion annotated movie subtitles. Described in *[XED: A Multilingual Dataset for Sentiment Analysis and Emotion Detection](https://www.aclweb.org/anthology/2020.coling-main.575.pdf)* ([Scholia](https://scholia.toolforge.org/work/Q105978198)).
* [Corona Dataset](https://github.com/certainlyio/corona_dataset) ⭐ 11 | 🐛 0 | 📅 2020-05-07 - Question dataset from Certainly annotated for domain and intent.
* [DaN+](https://github.com/bplank/DaNplus) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2023-01-24 - annotated for nested named entities on top of the entire Danish Universal Dependencies (UD\_Danish-DDT) and 3 new web domains and includes lexical normalization. Described in *[DaN+: Danish Nested Named Entities and Lexical Normalization](https://www.aclweb.org/anthology/2020.coling-main.583/)*
* [Danish review dataset](https://github.com/AlessandroGianfelici/danish_reviews_dataset) ⭐ 2 | 🐛 0 | 📅 2023-10-22 - Trustpilot-crawled dataset by Alessandro Gianfelici with  44,085 reviews .
* [SemDaX](https://github.com/coastalcph/semdax) ⭐ 1 | 🐛 1 | 📅 2022-12-08 - POS-tagged (only adjectives, nouns and verbs), super sense tagged and BIO-tagged sentences. For educational, teaching or research purposes only.
...
* [AFINN](https://github.com/fnielsen/afinn/tree/master/afinn/data) ⭐ 473 | 🐛 21 | 🌐 Jupyter Notebook | 📅 2022-04-04 - Danish lexicons annotated for sentiment.
* [The Danish Sentiment Lexicon](https://github.com/dsldk/danish-sentiment-lexicon) ⭐ 9 | 🐛 1 | 📅 2022-12-20 - Det Danske Sentimentleksikon (DDS) 13,859 headwords assigned with polarity values.
* [SAM lexicon](https://github.com/steffan267/Sentiment-Analysis-on-Danish-Social-Media/tree/master/Lexicon) ⭐ 9 | 🐛 0 | 📅 2020-05-28 - sentiment analysis word list extended from AFINN to 4275 lines. Described in *[Sentiment Analysis Multitool, SAM](https://raw.githubusercontent.com/lucaspuvis/SAM/master/Thesis.pdf)*.
* [concreteness-estimates-da](https://github.com/billdthompson/cogsci-auto-norm/blob/master/results/concreteness-estimates-da.csv) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2018-02-02 - Bill D. Thompson's concreteness estimates for Danish words, as detailed in *[Automatic Estimation of Lexical Concreteness in 77 Languages](http://pubman.mpdl.mpg.de/pubman/item/escidoc:2622741/component/escidoc:2622739/Thompson_Lupyan_2018.pdf)* ([Scholia](https://scholia.toolforge.org/work/Q56219750)).
...
* [Wordsim353-da](https://github.com/fnielsen/dasem/tree/master/dasem/data/wordsim353-da) ⭐ 18 | 🐛 6 | 🌐 Python | 📅 2020-09-24 - Danish translation by Finn Årup Nielsen of the English Wordsim353 English word pair set. Also available in [danlp](https://github.com/alexandrainst/danlp/blob/master/docs/docs/datasets.md#wordsim-353) ⚠️ Archived.
* [Four words](https://github.com/fnielsen/dasem/tree/master/dasem/data) ⭐ 18 | 🐛 6 | 🌐 Python | 📅 2020-09-24 - 100 odd-one-out sets of 4 words or phrases.
* [Danish-Similarity-Dataset](https://github.com/kuhumcst/Danish-Similarity-Dataset) ⭐ 8 | 🐛 0 | 📅 2020-05-22 - Similarity scores for 99 Danish word pairs by Nina Schneidermann and Bolette Sandford Pedersen. Also available in [danlp](https://github.com/alexandrainst/danlp/blob/master/docs/docs/datasets.md#danish-similarity-dataset) ⚠️ Archived.
* [Clinical similarity dataset](https://github.com/jannikskytt/DaClinWordEmbeddings/blob/main/Clinical%20similarity%20dataset.txt) ⭐ 0 | 🐛 0 | 📅 2023-03-07 - 289 word pairs score for similarity.

### Embeddings

* [Byte-Pair Encoding embedding](https://github.com/bheinzerling/bpemb) ⭐ 1,223 | 🐛 6 | 🌐 Python | 📅 2024-10-01 - Gensim-based subword embedding. A large number of Danish embeddings are available. They differ in the size of the vocabulary (from 1000 to 200000) and subspace dimensions (from 25 to 300).
...
* [A-ttack](https://github.com/ogtal/A-ttack) ⭐ 8 | 🐛 0 | 🌐 Python | 📅 2023-05-31 - Ælæctra-based model for detection of "textual attacks" developed by [Analyse & Tal](https://ogtal.dk/). Related to the Ha-te model.
* [Ha-te](https://github.com/ogtal/Ha-te) ⭐ 6 | 🐛 0 | 🌐 Python | 📅 2022-01-24 - Hate speech detection based on Ælæctra developed by [Analyse & Tal](https://ogtal.dk/). Related to the A-ttack model.
...
* [Lemmy](https://github.com/sorenlind/lemmy) ⭐ 80 | 🐛 0 | 🌐 Python | 📅 2021-09-20 - Lemmatizer for Danish in Python.
* [cstlemma](https://github.com/kuhumcst/cstlemma) ⭐ 37 | 🐛 0 | 🌐 C++ | 📅 2026-06-30 - lemmatiser.
* [spaCy](https://spacy.io) - Python-based package with lemmatization.

### Punctuation

* [punctfix](https://github.com/danspeech/punctfix) ⭐ 24 | 🐛 5 | 🌐 Python | 📅 2024-02-16 - "Adds punctuation and capitalization for a given text."

### Named entity recognition

* [flair+danlp ner-tagger](https://github.com/alexandrainst/danlp/blob/master/docs/docs/tasks/ner.md) ⚠️ Archived - Flair NER tagger trained by the Alexandra Institute.
* [daner](https://github.com/ITUnlp/daner) ⭐ 17 | 🐛 0 | 🌐 Shell | 📅 2019-07-23 - Named entity extraction from ITU NLP. Described in *[DKIE: Open Source Information Extraction for Danish](https://aclanthology.org/E14-2016.pdf)* ([Scholia](https://scholia.toolforge.org/work/Q28609956)).
* [DaLUKE](https://github.com/peleiden/daLUKE) ⭐ 9 | 🐛 7 | 🌐 Python | 📅 2022-01-09 - Danish named entity recognition based on LUKE. Described in *[DaLUKE: The Entity-aware,Danish Language Model](https://peleiden.github.io/bug-free-guacamole/main.pdf)*.
...
* [afinn](https://github.com/fnielsen/afinn/) ⭐ 473 | 🐛 21 | 🌐 Jupyter Notebook | 📅 2022-04-04 - Python package with AFINN Danish lexicon annotated for sentiment, also installable with `pip install afinn`.
* [Sentida](https://github.com/Guscode/Sentida/) ⭐ 22 | 🐛 3 | 🌐 Python | 📅 2021-12-14 - R package With Danish sentiment lexicon and handling of, e.g., negation. Detailed in *[SENTIDA: A New Tool for Sentiment Analysis in Danish](https://tidsskrift.dk/lwo/article/download/115711/163973/)* ([Scholia](https://scholia.toolforge.org/work/Q67272735)).
* [senda](https://github.com/ebanalyse/senda) ⭐ 18 | 🐛 0 | 🌐 Python | 📅 2021-05-25 - Python package with transformer-based sentiment analysis from Ekstra Bladet Analyse with as of 2021 [state-of-the-art performance](https://danlp-alexandra.readthedocs.io/en/latest/docs/tasks/sentiment_analysis.html#benchmark-of-polarity-classification) on one dataset.
* [Hisia](https://github.com/Proteusiq/hisia) ⚠️ Archived - Python package with pre-trained machine-learning based Danish sentiment analysis by Prayson Wilfred Daniel.

### Automatic Speech Recognition

* [kaldi-sprakbanken](https://github.com/kaldi-asr/kaldi/tree/master/egs/sprakbanken/s5) ⭐ 15,481 | 🐛 262 | 🌐 Shell | 📅 2025-09-22 - A recipe for training state-of-the-art(2017) speech recogniser for Danish based on the 16kHz NST database.
...
* [dacy](https://github.com/KennethEnevoldsen/DaCy) ⭐ 104 | 🐛 13 | 🌐 Python | 📅 2026-09-10 - Danish spaCy pipeline.
...
* [DaNLP](https://github.com/alexandrainst/danlp) ⚠️ Archived - Alexandra Institute's list of Danish resources
